...
## 用于游戏内文本的字体。
define gui.text_font = "SourceHanSansCN-Normal.otf"

## 用于角色名称的字体。
define gui.name_text_font = "SourceHanSerifCN-Heavy-4.otf"

## 用于游戏外文本的字体。
define gui.interface_text_font = "SourceHanSansCN-Normal.otf"
...
define gui.slot_button_height = 225
...
define gui.history_text_width = 650
